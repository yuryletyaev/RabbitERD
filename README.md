...
#### Способ 5: Режим разработки (для любых IDE)
```bash
python3 start_dev.py
```

#### Способ 6: Режим отладки
```bash
...
- **Простой запуск**: `python3 main.py`
- **С отладкой**: `python3 debug_app.py`
- **Проверка зависимостей**: `python3 start_dev.py`

### VS Code
- Используйте конфигурации из `.vscode/launch.json`
- Запуск: F5 или через панель отладки
- Доступны конфигурации: "RabbitMQ ERD Visualizer", "Debug RabbitMQ ERD", "Test API"

### Другие IDE
- **Любой редактор**: `python3 start_dev.py`
- **Отладка**: `python3 debug_app.py`
- **Тестирование**: `python3 test_api.py`
